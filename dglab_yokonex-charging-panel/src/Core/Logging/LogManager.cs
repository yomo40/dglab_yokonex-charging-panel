...
/// 
/// 策略：
/// - SQLite 数据库日志：可手动清理，支持保留 7/14/30 天
...
public class LogManager : IDisposable
{
    ...
    /// 可选的保留天数选项
    /// </summary>
    public static readonly int[] RetentionDaysOptions = { 7, 14, 30 };
    ...
    /// </summary>
    /// <param name="keepDays">保留天数（7/14/30）</param>
    ...
    public int GetDatabaseLogCount()
    {
        try
        {
            return Database.Instance.GetLogCount();
        }
        catch
        {
            return 0;
