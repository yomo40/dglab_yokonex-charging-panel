...
public record ConnectionConfig
{
    ...
    // YOKONEX 配置
    public string? ConnectCode { get; init; }
    ...
    // 连接元数据（用于持久化恢复，避免重启后类型/模式漂移）
    public ConnectionMode? ConnectionMode { get; init; }
    public DGLab.DGLabVersion? DGLabVersion { get; init; }
    public Yokonex.YokonexDeviceType? YokonexType { get; init; }
    public Yokonex.YokonexProtocolGeneration? YokonexProtocolGeneration { get; init; }
