...
#pragma warning disable CS0067 // ErrorOccurred 为接口兼容保留
...
#pragma warning restore CS0067
    ...
    public VirtualDevice(DeviceType type, string? name = null, string? id = null)
    {
        Id = id ?? $"virtual_{Guid.NewGuid():N}".Substring(0, 20);
        Type = type;
