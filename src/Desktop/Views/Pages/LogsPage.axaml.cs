...
public partial class LogsPage : UserControl
{
    ...
    private Border CreateLogRow(LogRecord log)
    {
        ...
        // 鼠标悬停效果
        row.PointerEntered += (s, e) => row.Background = new Avalonia.Media.SolidColorBrush(Avalonia.Media.Color.Parse("#1E1E2E"));
    ...
    {
        if (action.Contains("强度") || action.Contains("strength")) return "#8b5cf6";
        if (action.Contains("波形") || action.Contains("waveform")) return "#06b6d4";
